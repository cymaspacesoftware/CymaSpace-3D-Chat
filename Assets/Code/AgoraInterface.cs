...
{
    private static string appId = "6ecf135bde5942378a2a73c913df6bda";
...
public void OnChatSceneLoaded()
{
	...
	VideoSurface surface = go.GetComponent<VideoSurface>();
	surface.mAdjustTransform += OnTransformDelegate;
}
